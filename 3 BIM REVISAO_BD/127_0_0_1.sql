...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19-Ago-2022 às 14:06
...
(1, 'ETEC MCM', 'etecmcm@gmail.com', 'SP'),
(2, 'ETEC LG', 'eteclaurogomes@gmail.com', 'RJ'),
(3, 'ETEC MAUA', 'laurogomes@email.com', 'RJ');
...
(1, 'BORRACHA', 'AZUL', '2.53'),
(2, 'CADERNO', 'VERMELHO', '22.99'),
(3, 'LÁPIS', 'GRAFITE', '1.49'),
(4, 'PASTA', 'VERDE', '12.89'),
(5, 'FICHÁRIO', 'OLOGRÁFICO', '102.79'),
(6, 'CANETA BIC', 'PRETA', '2.99'),
(7, 'MARCA TEXTO', 'AMARELO FLUORESCENTE', '3.99'),
(8, 'CORRETIVO EM FITA', 'BRANCO', '10.59'),
(9, 'BRUSH PEN', 'PRETO', '12.49'),
(10, 'APONTADOR', 'ROSA', '2.49');
